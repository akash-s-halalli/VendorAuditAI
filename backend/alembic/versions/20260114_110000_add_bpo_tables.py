...
def upgrade():
    ...
    if "bpo_providers" not in existing_tables:
        op.create_table(
            "bpo_providers",
            ...
            sa.Column("geographic_locations", sa.Text, nullable=True),
            ...
            sa.Column("sla_requirements", sa.Text, nullable=True),
        ...
        op.create_index("ix_bpo_providers_organization_id", "bpo_providers", ["organization_id"])
        op.create_index("ix_bpo_providers_service_type", "bpo_providers", ["service_type"])
        op.create_index("ix_bpo_providers_data_access_level", "bpo_providers", ["data_access_level"])

    # 2. Create bpo_processes table
    if "bpo_processes" not in existing_tables:
        op.create_table(
            "bpo_processes",
            sa.Column("id", sa.String(36), primary_key=True),
            sa.Column("provider_id", sa.String(36), sa.ForeignKey("bpo_providers.id", ondelete="CASCADE"), nullable=False),
            ...
            sa.Column("controls_required", sa.Text, nullable=True),
    ...
    if "bpo_assessments" not in existing_tables:
        op.create_table(
            "bpo_assessments",
            sa.Column("id", sa.String(36), primary_key=True),
            sa.Column("provider_id", sa.String(36), sa.ForeignKey("bpo_providers.id", ondelete="CASCADE"), nullable=False),
            sa.Column("organization_id", sa.String(36), sa.ForeignKey("organizations.id", ondelete="CASCADE"), nullable=False),
            sa.Column("assessor_id", sa.String(36), sa.ForeignKey("users.id", ondelete="SET NULL"), nullable=True),
            sa.Column("assessment_date", sa.DateTime, nullable=True),
            sa.Column("assessment_type", sa.String(50), nullable=False, default="periodic"),
        ...
        op.create_index("ix_bpo_assessments_provider_id", "bpo_assessments", ["provider_id"])
        op.create_index("ix_bpo_assessments_organization_id", "bpo_assessments", ["organization_id"])
        op.create_index("ix_bpo_assessments_assessor_id", "bpo_assessments", ["assessor_id"])
        op.create_index("ix_bpo_assessments_status", "bpo_assessments", ["status"])
        op.create_index("ix_bpo_assessments_assessment_type", "bpo_assessments", ["assessment_type"])

    # 4. Create bpo_controls table
    if "bpo_controls" not in existing_tables:
        op.create_table(
            "bpo_controls",
            sa.Column("id", sa.String(36), primary_key=True),
            sa.Column("process_id", sa.String(36), sa.ForeignKey("bpo_processes.id", ondelete="CASCADE"), nullable=False),
            ...
            sa.Column("control_category", sa.String(50), nullable=False, default="operational"),
        ...
        op.create_index("ix_bpo_controls_control_category", "bpo_controls", ["control_category"])
